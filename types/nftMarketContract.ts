...
export interface NftMarketContractEventsContext {
  ...
  NFTCreated(...parameters: any): EventFilter;
...
export interface NFTCreatedEventEmittedResponse {
  id: BigNumberish;
  price: BigNumberish;
  creator: string;
  isListed: boolean;
...
export interface NftMarketContract {
   ...
   * Type: function
   */
  LISTING_PRICE(overrides?: ContractCallOverrides): Promise<BigNumber>;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   ...
   * Type: function
   */
  getMyNFTs(overrides?: ContractCallOverrides): Promise<NftitemResponse[]>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
